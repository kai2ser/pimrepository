...
import { Database, BookOpen, ScrollText, Info } from "lucide-react";
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex h-14 items-center justify-between">
              <Link href="/" className="flex items-center gap-2.5">
                ...
                <span className="font-semibold text-sm">PIM Repository</span>
                <span className="hidden sm:inline text-xs text-muted-foreground border-l pl-2.5 ml-0.5">
